            ...
            <div className="h-full overflow-scroll lg:flex" ref={conatinerRef}>
                ...
                <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:1/2">
                    ...
                    <div className="flex flex-col gap-12 justify-center">
                        ...
                        <p className="text-lg">
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita omnis commodi consequuntur tempora, inventore provident similique, 
                            consequatur ipsa dolore accusantium nobis nesciunt excepturi minima quo recusandae ipsum! Officia, ut labore.
                            Aspernatur cum assumenda totam debitis tempora suscipit ipsa mollitia ab dolorum! Tempora repellat tempore libero blanditiis?
                        </p>
                        <span className="italic">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi aspernatur assumenda eum ad vero? 
                        </span>
                        {/* SIGNATURE */}
                    ...
                    <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
                        ...
                        >
                            ...
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">F#</div>
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">ASP.NET</div>
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">NET MAUI</div>
